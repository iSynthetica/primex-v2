...
/* plugins-status.twig */
class __TwigTemplate_e12319eb453c7ea80b23b7f84560f440f4be6fe932ee522cf99cc08e3add5db1 extends \WPML\Core\Twig\Template
{
    ...
    <div class=\"wcml-section-header\">
        <h3>
            {{ strings.status }}
            <i class=\"otgs-ico-help wcml-tip\" data-tip=\"{{ strings.depends|e }}\"></i>
        </h3>
    </div>
    <div class=\"wcml-section-content\">
        <ul class=\"wcml-status-list wcml-plugins-status-list\">
...
</div>", "plugins-status.twig", "/Users/user/Sites/primex/public_html/wp-content/plugins/woocommerce-multilingual/templates/status/plugins-status.twig");
    }
}
