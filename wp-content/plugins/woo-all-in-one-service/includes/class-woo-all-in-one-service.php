 ...
 * @subpackage Woo_All_In_One_Service/includes
 */
...
class Woo_All_In_One_Service {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Woo_All_In_One_Service_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'WOO_ALL_IN_ONE_SERVICE_VERSION' ) ) {
			$this->version = WOO_ALL_IN_ONE_SERVICE_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'woo-all-in-one-service';
	 ...
	 *
	 * - Woo_All_In_One_Service_Loader. Orchestrates the hooks of the plugin.
	 * - Woo_All_In_One_Service_i18n. Defines internationalization functionality.
	 * - Woo_All_In_One_Service_Admin. Defines all hooks for the admin area.
	 * - Woo_All_In_One_Service_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-woo-all-in-one-service-i18n.php';
	 ...
	 *
	 * Uses the Woo_All_In_One_Service_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Woo_All_In_One_Service_i18n();
...
//        $this->loader->add_filter( 'query_vars', $plugin_public, 'custom_endpoints_query_vars' );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Woo_All_In_One_Service_Loader    Orchestrates the hooks of the plugin.
	 */
