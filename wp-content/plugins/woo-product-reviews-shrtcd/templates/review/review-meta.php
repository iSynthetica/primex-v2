...
if ( '0' === $comment->comment_approved ) { ?>
	<p class="meta">
		<em class="woocommerce-review__awaiting-approval"<?php echo $show_schema ? ' itemprop="author"' : ''; ?>>
...
<?php } else { ?>
	...
	<p class="meta">
		<strong class="woocommerce-review__author"<?php echo $show_schema ? ' itemprop="author"' : ''; ?>><?php comment_author(); ?> </strong>
		<?php
