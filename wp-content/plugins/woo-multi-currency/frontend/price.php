...
class WOOMULTI_CURRENCY_F_Frontend_Price {
	...
	public function __construct() {
		...
		if ( $this->settings->get_enable() ) {
			...
			add_filter( 'woocommerce_variation_prices', array( $this, 'get_woocommerce_variation_prices' ), 99, 2 );
			...
			if ( $this->settings->get_price_switcher() ) {
				add_action( 'woocommerce_single_product_summary', array( $this, 'add_price_switcher' ), 9, 2 );
			}
		}
	}
