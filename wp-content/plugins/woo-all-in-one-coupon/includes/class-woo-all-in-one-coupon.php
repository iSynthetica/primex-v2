...
class Woo_All_In_One_Coupon {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Woo_All_In_One_Coupon_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'WOO_ALL_IN_ONE_COUPON_VERSION' ) ) {
			$this->version = WOO_ALL_IN_ONE_COUPON_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'woo-all-in-one-coupon';
	 ...
	 *
	 * - Woo_All_In_One_Coupon_Loader. Orchestrates the hooks of the plugin.
	 * - Woo_All_In_One_Coupon_i18n. Defines internationalization functionality.
	 * - Woo_All_In_One_Coupon_Admin. Defines all hooks for the admin area.
	 * - Woo_All_In_One_Coupon_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-woo-all-in-one-coupon-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-woo-all-in-one-coupon-i18n.php';
	 ...
	 *
	 * Uses the Woo_All_In_One_Coupon_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Woo_All_In_One_Coupon_i18n();
	 ...
	 *
	 * @since     1.0.0
	 * @return    Woo_All_In_One_Coupon_Loader    Orchestrates the hooks of the plugin.
	 */
