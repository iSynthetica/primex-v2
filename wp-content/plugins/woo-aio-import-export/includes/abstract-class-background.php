...
if ( ! class_exists( 'WP_Async_Request', false ) ) {
    include_once WOOAIOIE_PATH . 'includes/wp-background-processing/classes/wp-async-request.php';
}

if ( ! class_exists( 'WP_Background_Process', false ) ) {
    include_once WOOAIOIE_PATH . 'includes/wp-background-processing/classes/wp-background-process.php';
}

abstract class Wooaioie_Background_Process extends WP_Background_Process {
