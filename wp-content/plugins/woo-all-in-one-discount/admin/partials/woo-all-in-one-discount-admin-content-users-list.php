...
<div id="wooaio-discount-create-action" class="wooaio-discount-create-closed">
    <button id="open-create-discount-rule" class="button button-primary" type="button"><?php _e('Create new users rule', 'woo-all-in-one-discount'); ?></button>
...
<div id="wooaio-discount-list">
    ...
    if (empty($users_rules)) {
        ...
        <table class="wp-list-table widefat fixed striped pages">
            ...
            <tbody id="the-list">
            <?php
            foreach ($users_rules as $discount_rule_id => $discount_rule) {
                ?>
                <tr>
                    ...
                    <td class="column-primary has-row-actions">
                        <a href="?page=wooaiodiscount&tab=users&discount_id=<?php echo $discount_rule_id; ?>">
                    ...
                    <td data-colname="<?php _e('Action', 'woo-all-in-one-discount'); ?>">
                        <button
                                ...
                                class="button button-small delete-user-rule"
                                type="button"
                                data-id="<?php echo $discount_rule_id; ?>"
                                data-single="no"
                                data-confirm="<?php _e('Are you sure you want to delete this users rule?', 'woo-all-in-one-discount'); ?>"
