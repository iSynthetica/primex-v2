...
const SOURCE = {
    scripts: [
        ...
        // VENDORS + '/twitterFeedFetcher.js',
        VENDORS + '/jRespond.js',
        // VENDORS + '/instafeed.js',
        // VENDORS + '/Jribbble.js',
        VENDORS + '/jquery.mb.YTPlayer.js',
        VENDORS + '/js-cookie.js',
        // VENDORS + '/easy-pie-chart.js',
        // VENDORS + '/jquery-flickr-plugin.js',
        VENDORS + '/jquery.appear.js',
        VENDORS + '/animsition.js',
        VENDORS + '/skrollr.js',
        VENDORS + '/countdown.js',
        VENDORS + '/jquery-countTo.js',
        VENDORS + '/owlCarousel.js',
        VENDORS + '/Morphext.js',
        VENDORS + '/isotope.js',
        VENDORS + '/imagesLoaded.js',
        VENDORS + '/Swiper.js',
        VENDORS + '/jquery-bbq-plugin.js',
