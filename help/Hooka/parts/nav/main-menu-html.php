...
<ul class="clearlist">
    ...
    <!-- Item With Sub -->
    <li>
        <a href="#" class="mn-has-sub active">Home <i class="fas fa-angle-down"></i></a>
    ...
    <!-- Item With Sub -->
    <li>
        <a href="#" class="mn-has-sub">Pages <i class="fas fa-angle-down"></i></a>
    ...
    <!-- Item With Sub -->
    <li>
        <a href="#" class="mn-has-sub">Elements <i class="fas fa-angle-down"></i></a>
        ...
        <ul class="mn-sub mn-has-multi">
            ...
            <li class="mn-sub-multi">
                ...
                <ul>
                    <li>
                        <a href="elements-accordions.html"><i class="fas fa-plus-circle fa-sm"></i> Accordions</a>
                    </li>
                    <li>
                        <a href="elements-bars.html"><i class="fas fa-tachometer-alt fa-sm"></i> Bars (Progress)</a>
                    </li>
                    <li>
                        <a href="elements-buttons.html"><i class="fas fa-link fa-sm"></i> Buttons</a>
                    </li>
                    <li>
    ...
    <!-- Item With Sub -->
    <li>
        <a href="#" class="mn-has-sub">Portfolio <i class="fas fa-angle-down"></i></a>
    ...
    <!-- Item With Sub -->
    <li>
        <a href="#" class="mn-has-sub">Blog <i class="fas fa-angle-down"></i></a>
    ...
    <!-- Item With Sub -->
    <li>
        <a href="#" class="mn-has-sub">Shop <i class="fas fa-angle-down"></i></a>
    ...
    <!-- Languages -->
    <li>
        <a href="#" class="mn-has-sub">Eng <i class="fas fa-angle-down"></i></a>
