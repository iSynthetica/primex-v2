        ...
        <div class="section-text mb-50 mb-sm-20">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 mb-sm-50 mb-xs-30">
                    ...
                    pellentesque mattis. Maecenas volutpat, diam enim sagittis quam, id porta quam. Sed id dolor
            ...
            <div class="col-sm-4 mb-xs-30 wow fadeInUp">
                <div class="team-item">
                    ...
                    <div class="team-item-image">
                        ...
                        <img src="<?php echo SNTH_IMAGES_URL; ?>/team/team-1.jpg" alt=""/>
            ...
            <div class="col-sm-4 mb-xs-30 wow fadeInUp" data-wow-delay="0.1s">
                <div class="team-item">
                    ...
                    <div class="team-item-image">
                        ...
                        <img src="<?php echo SNTH_IMAGES_URL; ?>/team/team-2.jpg" alt=""/>
                        ...
                        <div class="team-item-detail">
                            ...
                            <p>
                                Curabitur augue, nec finibus mauris pretium eu. Duis placerat ex gravida nibh
                                tristique porta.
                            </p>
            ...
            <div class="col-sm-4 mb-xs-30 wow fadeInUp" data-wow-delay="0.2s">
                <div class="team-item">
                    ...
                    <div class="team-item-image">
                        ...
                        <img src="<?php echo SNTH_IMAGES_URL; ?>/team/team-3.jpg" alt=""/>
...
<section class="page-section bg-dark bg-dark-alfa-90 fullwidth-slider"
         data-background="<?php echo SNTH_IMAGES_URL; ?>/full-width-images/section-bg-3.jpg">
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                ...
                <div class="small-item-carousel black owl-carousel mb-0 animate-init"
                    ...
                    <!-- Logo Item -->
                    <div class="logo-item">
                        <img src="<?php echo SNTH_IMAGES_URL; ?>/clients-logos/client-1.png" width="67" height="67"
                             alt=""/>
                    </div>
                    <!-- End Logo Item -->
                    ...
                    <!-- Logo Item -->
                    <div class="logo-item">
                        <img src="<?php echo SNTH_IMAGES_URL; ?>/clients-logos/client-2.png" width="67" height="67"
                             alt=""/>
                    </div>
                    <!-- End Logo Item -->
                    ...
                    <!-- Logo Item -->
                    <div class="logo-item">
                        <img src="<?php echo SNTH_IMAGES_URL; ?>/clients-logos/client-3.png" width="67" height="67"
                             alt=""/>
                    </div>
                    <!-- End Logo Item -->
                    ...
                    <!-- Logo Item -->
                    <div class="logo-item">
                        <img src="<?php echo SNTH_IMAGES_URL; ?>/clients-logos/client-4.png" width="67" height="67"
                             alt=""/>
                    </div>
                    <!-- End Logo Item -->
                    ...
                    <!-- Logo Item -->
                    <div class="logo-item">
                        <img src="<?php echo SNTH_IMAGES_URL; ?>/clients-logos/client-5.png" width="67" height="67"
                             alt=""/>
                    </div>
                    <!-- End Logo Item -->
                    ...
                    <!-- Logo Item -->
                    <div class="logo-item">
                        <img src="<?php echo SNTH_IMAGES_URL; ?>/clients-logos/client-6.png" width="67" height="67"
                             alt=""/>
                    </div>
                    <!-- End Logo Item -->
