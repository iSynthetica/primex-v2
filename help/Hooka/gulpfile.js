...
const FOUNDATION = MODULES + '/foundation-sites';
...
const SOURCE = {
    scripts: [
        ...
        // MODULES + '/what-input/dist/what-input.js',
        ...
        // ImagesLoaded
        // MODULES + '/imagesloaded/imagesloaded.pkgd.min.js',

        // Lightgallery
        // MODULES + '/lightgallery/dist/js/lightgallery.js',
        // MODULES + '/lg-autoplay/dist/lg-autoplay.js',
        // MODULES + '/lg-fullscreen/dist/lg-fullscreen.js',
        // MODULES + '/lg-hash/dist/lg-hash.js',
        // MODULES + '/lg-pager/dist/lg-pager.js',
        // MODULES + '/lg-share/dist/lg-share.js',
        // MODULES + '/lg-thumbnail/dist/lg-thumbnail.js',
        // MODULES + '/lg-video/dist/lg-video.js',
        // MODULES + '/lg-zoom/dist/lg-zoom.js',
    ...
    fonts: [
        ...
        // MODULES + '/font-awesome/fonts/**/*.{ttf,woff,woff2,eot,svg}',
        // MODULES + '/socicon/font/**/*.{ttf,woff,woff2,eof,svg}',
        // MODULES + '/lightgallery/dist/fonts/**/*.{ttf,woff,woff2,eof,svg}',
        // MODULES + '/slick-carousel/slick/fonts/**/*.{ttf,woff,woff2,eof,svg}',
        // VENDORS + '/woocommerce/assets/fonts/**/*.{ttf,woff,woff2,eof,svg}',
    ],
