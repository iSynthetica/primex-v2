...
<form
    class="variations_form form cart"
		...
		<table class="variations mb-10" cellspacing="0">
			<tbody>
				<?php foreach ( $attributes as $attribute_name => $options ) : ?>
					<tr>
						<td>
                            <label class="font-alt" for="<?php echo esc_attr( sanitize_title( $attribute_name ) ); ?>">
						...
						<td class="value">
							<?php
                            snth_wc_dropdown_variation_attribute_options( array(
									'options'   => $options,
